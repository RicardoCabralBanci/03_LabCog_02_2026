...
Registro cronológico das sessões de trabalho. Cada entrada documenta o que foi feito, decisões tomadas e próximos passos.

---

## Guia de Nova Sessão

1. Consulte o **[[01_TemplateLog|Template de Log]]**.
2. Crie um novo arquivo no `01_Core/` seguindo o ID sequencial: `NN_LogSessao...`
3. Registre a nova entrada no **Histórico** abaixo.

---

## Histórico de Entradas

*   **2026-02-13b — Em casa**: [[38_LogSessao2026-02-13b|Log da sessão]].
...
*   **2026-02-07 — Consolidação e Organização**: [[07_LogSessao2026-02-07|Log da sessão]]. Consolidação dos 2 CLAUDE.md em 1 (raiz). Criação do índice de ferramentas. Pasta `50_RandNotes/`.
*   **2026-02-06 — Fundação**: Criação da estrutura inicial do Laboratório Cognitivo. Templates adaptados do KHSV5.
