...
' IMPORTANTE: PLT e PCK estão redirecionando para CCMX temporariamente.
' Isso implica que eles compartilharão o mesmo range de linhas na Base de Dados se o C# não filtrar.
Sub Gerar_PLT()
    Call ExportarParaNovoGerador("CCMX")
End Sub
