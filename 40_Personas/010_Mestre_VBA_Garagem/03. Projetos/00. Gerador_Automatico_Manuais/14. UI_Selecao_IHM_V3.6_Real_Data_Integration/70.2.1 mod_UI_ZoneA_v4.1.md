...
Private Sub Load_Catalog_From_DB()
    ...
    On Error Resume Next
    ' Prioriza o nome padrão definido na arquitetura V3.6
    ...
    ' --- SE O BANCO NÃO EXISTE, CARREGA MOCK DE EMERGÊNCIA ---
    If wsDB Is Nothing Then
        ...
        With Catalog(2)
            ...
            .Status = "Ativo": .Engine = "WinCC TIA": .Descricao = "Painéis Siemens Standard."
