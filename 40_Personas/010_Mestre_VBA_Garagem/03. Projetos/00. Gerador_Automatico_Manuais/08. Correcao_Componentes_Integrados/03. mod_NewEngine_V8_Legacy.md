# Arquivo Histórico: mod_NewEngine_V8 (Legado)
**Data de Arquivamento**: 27/01/2026
**Descrição**: Versão estável anterior à implementação da correção de tabelas integradas. Contém a lógica de envio de metadados da capa (V8) mas não envia tabelas dinâmicas.
