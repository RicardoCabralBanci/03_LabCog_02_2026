...
' ==========================================================================================
' MÓDULO: mod_NewEngine_V8 (Ponte Geográfica - Versão Chave Mestra)
' DESCRIÇÃO: Ponte entre Botões do Excel e Motor C# V2 + Metadados da Capa (Tipo e Modelo Separados)
' FUNCIONAMENTO: Recebe o tipo da máquina (filtro), coleta nome completo do Form Info (capa), gera manifesto e chama o EXE.
...
Private Sub ExportarParaNovoGerador(machineType As String)
    ...
    Dim valMaquinaFull As String ' [NOVO V8] Variável para o nome completo da máquina
    ...
    ' --- [INÍCIO] INJEÇÃO DE DADOS DA CAPA (V8) ---
    ...
    valRevisao = "0"
    valAno = Year(Now)
    valMaquinaFull = machineType ' Default: Se não achar nome completo, usa o código do botão
