...
> Codigo VBA atual -- convertido automaticamente de `mod_NewEngine_V5.bas`
...
' ==========================================================================================
' M�DULO: mod_NewEngine_V9 (Ponte Geogr�fica - Vers�o Tabelas Din�micas)
' DESCRI��O: Ponte entre Bot�es do Excel e Motor C# V2 + Metadados Capa + Tabelas Din�micas
' FUNCIONAMENTO: Recebe tipo m�quina, metadados, tabelas de configura��o, gera manifesto e chama EXE.
...
' --- PONTOS DE ENTRADA PARA OS BOT�ES ---
...
Private Sub ExportarParaNovoGerador(machineType As String)
    ...
    If Not fso.FileExists(exePath) Then
        MsgBox "ERRO CR�TICO: Motor 'NewGeradorV2.exe' n�o encontrado.", vbCritical
        Exit Sub
    End If
    
    ' 3. Constru��o do Manifesto
    ...
    ' --- [TABELAS DIN�MICAS - V9] ---
    ' Injeta os dados das tabelas auxiliares (Componentes, �reas, etc.)
...
' --- FUN��ES AUXILIARES DE EXTRA��O DE TABELAS (V9) ---
...
Private Function ExtractTableData() As String
    ...
    sb = sb & ExtractSheetTable(Planilha4, "Componentes integrados", "B", "D", 4)
    
    ' 2. �reas e segmentos -> Planilha8 -> B2:D...
    sb = sb & ExtractSheetTable(Planilha8, "�reas e segmentos", "B", "D", 2)
