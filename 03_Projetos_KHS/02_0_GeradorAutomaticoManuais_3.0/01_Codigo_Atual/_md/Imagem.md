...
> Codigo VBA atual -- convertido automaticamente de `Imagem.bas`
...
Application.ScreenUpdating = False
    ...
    If Planilha2.Range("D4").Value = "" Then
        MsgBox "O arquivo n�o apresenta imagens marcadas para substituir.", vbOKOnly + vbInformation, "Substitui��o n�o necess�ria!"
        End
    End If
