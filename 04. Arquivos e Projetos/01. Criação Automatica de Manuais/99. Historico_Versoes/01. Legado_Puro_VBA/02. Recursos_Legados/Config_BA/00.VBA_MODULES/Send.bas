...
'Fill control
    ...
    If Planilha3.Range("F25").Value = "Essa" Then
        ...
        If Planilha2.Range("E2").Value <> "" Then
            em.Body = "Mensagem automática - Configurador de manuais" & vbLf & vbLf & _
            "Manual gerado com sucesso, assim finalizamos o procedimento para a posição K-" & Info.Projeto & vbLf & vbLf & Planilha2.Range("E2").Value
        GoTo loc: End If
    ...
    'DVD - Precisa ter um check de se foi alterado as tabelas e imagens, ou reforçar para revisar o arquivo (daí inclui o pedido de revisão em todos)
    If Planilha3.Range("F294").Value = "Essa" Then
    
        If Planilha2.Range("E2").Value <> "" Then
            em.Body = "Mensagem automática - Configurador de manuais" & vbLf & vbLf & _
            "Manual gerado com sucesso! Alguns conteúdos, para a posição K-" & Info.Projeto & _
            ", devem ser revisados ou alterados manualmente. Assim que o procedimento for finalizado, informe o término respondendo a esse email." & _
...
With Planilha3
    .Range("N17").Value = "Mecânica - Abas preenchidas: ": .Range("N18").Value = "Mecânica - Abas não preenchidas: "
    .Range("N20").Value = "Elétrica - Abas preenchidas: ": .Range("N21").Value = "Elétrica - Abas não preenchidas: "
    ...
    If .Range("F26").Value = "Não" Then
        ok = "Manual não pode ser gerado."
    Else: ok = "Manual pode ser gerado.": End If

    em.Body = "Mensagem automática - Configurador de manuais" & vbLf & vbLf & mec & vbLf & vbLf & ele & vbLf & vbLf & ok & vbLf & vbLf & ThisWorkbook.Path
...
With Planilha3
    .Range("N153").Value = "Mecânica - Abas preenchidas: ": .Range("N154").Value = "Mecânica - Abas não preenchidas: "
    .Range("N156").Value = "Elétrica - Abas preenchidas: ": .Range("N157").Value = "Elétrica - Abas não preenchidas: "
...
With Planilha3
    .Range("N289").Value = "Mecânica - Abas preenchidas: ": .Range("N290").Value = "Mecânica - Abas não preenchidas: "
    .Range("N292").Value = "Elétrica - Abas preenchidas: ": .Range("N293").Value = "Elétrica - Abas não preenchidas: "
...
With Planilha3
    .Range("N455").Value = "Mecânica - Abas preenchidas: ": .Range("N456").Value = "Mecânica - Abas não preenchidas: "
...
With Planilha3
    .Range("N545").Value = "Mecânica - Abas preenchidas: ": .Range("N546").Value = "Mecânica - Abas não preenchidas: "
...
With Planilha3
    .Range("N657").Value = "Mecânica - Abas preenchidas: ": .Range("N658").Value = "Mecânica - Abas não preenchidas: "
...
With Planilha3
    .Range("N736").Value = "Mecânica - Abas preenchidas: ": .Range("N737").Value = "Mecânica - Abas não preenchidas: "
    .Range("N739").Value = "Elétrica - Abas preenchidas: ": .Range("N740").Value = "Elétrica - Abas não preenchidas: "
