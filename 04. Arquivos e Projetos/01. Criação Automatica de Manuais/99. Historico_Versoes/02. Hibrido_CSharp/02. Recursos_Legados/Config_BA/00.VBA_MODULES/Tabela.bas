...
On Error GoTo 0
    ...
    objWS.Cells(HEADER_ROW, ALT_COL).Value = "Título"
...
Dim str As String
    ...
    If Planilha2.Range("D4").Value = "" Then
        MsgBox "O arquivo não apresenta tabelas marcadas para substituir.", vbOKOnly + vbInformation, "Substituição não necessária!"
        End
    End If
