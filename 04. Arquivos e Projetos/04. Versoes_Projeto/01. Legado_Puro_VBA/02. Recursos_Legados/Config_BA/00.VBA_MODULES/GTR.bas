...
'On Error GoTo 0
    ...
    If Planilha3.Range("B144") = "Yes" Then
    ...
    For i = 142 To 271
        ...
        If Planilha3.Range("B144") = "Yes" Then   'IHM yes + 1 row
            Select Case i
            Case 145 To 193, 232 To 270 'IHM yes + 1 to before Chapter 5 start, After Chapter 5 end to "Contra capa" -1
                'Do nothing
            Case Else: GoTo Generate: End Select: End If
        
        If Planilha3.Range("B144") = "No" Then
...
On Error GoTo hand
    ...
    For Each oTable In objDoc.Tables
            ...
            If oTable.Title = "Áreas e segmentos" Then
                Set erng = Planilha16.Range("B2:D" & Planilha16.Range("D" & Rows.Count).End(xlUp).Row)
                erng.Copy
                Wait (1)
            ...
            If oTable.Title = "Dispositivos de comando" Then
                Set erng = Planilha17.Range("B3:D" & Planilha17.Range("B" & Rows.Count).End(xlUp).Row)
                erng.Copy
                Wait (1)
            ...
            If oTable.Title = "Dispositivos de aviso" Then
                Set erng = Planilha18.Range("B3:D" & Planilha18.Range("B" & Rows.Count).End(xlUp).Row)
                erng.Copy
                Wait (1)
            ...
            If oTable.Title = "Tipos de embalagens grupadas" Then
                Set erng = Planilha15.Range("B2:F" & Planilha15.Range("B" & Rows.Count).End(xlUp).Row)
                erng.Copy
                Wait (1)
